...
(module+ test
  ...
  ;; #2
  (test (expr-i->c (instanceofI (numI 0) 'fish) 'object)
        (instanceofC (numC 0) 'fish))
  ...
  (test (expr-i->c (newarrayI (numT) (numI 1) (numI 2)) 'object)
        (newarrayC (numT) (numC 1) (numC 2)))
  (test (expr-i->c (arrayrefI (numI 1) (numI 2)) 'object)
        (arrayrefC (numC 1) (numC 2)))
  (test (expr-i->c (arraysetI (numI 1) (numI 2) (numI 3)) 'object)
        (arraysetC (numC 1) (numC 2) (numC 3))))
